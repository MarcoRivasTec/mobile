					...
					<View style={solPermisos.modalContainer}>
						<View style={solPermisos.contentContainer}>
							...
							<View style={solPermisos.titleContainer}>
								<Text style={solPermisos.titleText}>Solicitud de Permisos</Text>
							</View>
							...
							<View style={solPermisos.tipoContainer}>
								...
								<View style={solPermisos.tipoBox}>

								</View>
							</View>
							{/* Comentarios */}
							<View style={solPermisos.comentariosContainer}>
								<Text style={solPermisos.comentariosTitle}>Comentarios</Text>
								<TextInput
							...
							{/* Back button */}
							<TouchableOpacity onPress={onExit} style={solPermisos.exitButton}>
								<Text style={solPermisos.textExitButton}>Volver</Text>
							</TouchableOpacity>
						</View>
					</View>
				</View>
